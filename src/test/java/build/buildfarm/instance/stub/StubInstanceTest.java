...
public class StubInstanceTest {
  ...
  public void inputStreamThrowsNonDeadlineExceededCausal()
    ...
    try (InputStream in =
        instance.newBlobInput(
            Compressor.Value.IDENTITY, unavailableDigest, 0, 1, SECONDS, RequestMetadata.getDefaultInstance())) {
  ...
  public void inputStreamRetriesOnDeadlineExceededWithProgress()
    ...
    try (InputStream in =
        instance.newBlobInput(Compressor.Value.IDENTITY, delayedDigest, 0, 1, SECONDS, RequestMetadata.getDefaultInstance())) {
      ByteStreams.copy(in, out);
    }
  ...
  public void inputStreamThrowsOnDeadlineExceededWithoutProgress()
    ...
    try (InputStream in =
        instance.newBlobInput(Compressor.Value.IDENTITY, timeoutDigest, 0, 1, SECONDS, RequestMetadata.getDefaultInstance())) {
      ByteStreams.copy(in, out);
    } catch (IOException e) {
      ioException = e;
    }
