...
public class ResourceParser {
  ...
  private static void addCompressorName(ImmutableList.Builder<String> resource, Compressor.Value compression) {
    if (compression == Compressor.Value.IDENTITY) {
      ...
      switch (compression) {
      case IDENTITY: break;
      case ZSTD: resource.add("zstd"); break;
      case DEFLATE: resource.add("deflate"); break;
      default:
  ...
  private static void addBlobResource(ImmutableList.Builder<String> resource, BlobInformation blob) {
