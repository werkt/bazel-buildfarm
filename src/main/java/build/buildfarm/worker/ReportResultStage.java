...
public class ReportResultStage extends SuperscalarPipelineStage {
  ...
  public ReportResultStage(WorkerContext workerContext, PipelineStage output, PipelineStage error) {
    super("ReportResultStage", workerContext, output, error, workerContext.getReportResultStageWidth());
  }
  ...
  protected void iterate() throws InterruptedException {
    ...
    Thread reporter =
        new Thread(
            new ResultReporter(workerContext, executionContext, this), "ReportResultStage.reporter");
